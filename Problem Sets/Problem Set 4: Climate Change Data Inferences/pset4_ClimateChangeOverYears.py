...
def generate_models(x, y, degs):
    ...
    """
    return [np.polyfit(x, y, degree) for degree in degs]
...
def evaluate_models_on_training(x, y, models, title=""):
    ...
    for model in models:
        ...
        pylab.plot(xVals, estYVals, "r-", label="Degree: " + str(len(model) - 1) + "\nR**2 : " + str(r2))
        pylab.title(title) if title else pylab.title("Temperature over the Years")
        pylab.xlabel("Year")
...
evaluate_models_on_training(x, y, models, "Avg. Temperature on Jan 10 over the years")
...
evaluate_models_on_training(x1, y, models, "Avg. Annual Temperature over the years")
